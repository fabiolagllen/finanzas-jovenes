...
(function(){
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      .fj-mobile-nav{
        ...
        box-shadow:0 15px 45px rgba(0,0,0,.55),0 0 25px rgba(57,255,136,.08)!important;
        backdrop-filter:blur(18px)!important;
        -webkit-backdrop-filter:blur(18px)!important;
        z-index:9998!important;
      }
      .fj-mobile-nav button{
        flex:1!important;
        min-width:0!important;
        border:0!important;
        background:transparent!important;
        color:#8fa197!important;
      ...
      .fj-mobile-nav button span{font-size:1.18rem!important;line-height:1!important}
      ...
      .fj-install-card h2{font-size:1.8rem!important;margin:0 0 8px!important;letter-spacing:-.8px!important}.fj-install-card h2 span{color:#39ff88!important}
      ...
      .fj-install-actions{display:grid!important;gap:10px!important}.fj-install-actions button{width:100%!important;border-radius:14px!important;padding:14px 16px!important;font-size:.95rem!important;font-weight:800!important;cursor:pointer!important;transition:.2s!important}
      .fj-install-main{background:#39ff88!important;color:#041008!important;border:1px solid #39ff88!important}.fj-install-main:hover{transform:translateY(-2px)!important;box-shadow:0 10px 28px rgba(57,255,136,.20)!important}
      .fj-install-web{background:rgba(255,255,255,.035)!important;color:#dce9e1!important;border:1px solid rgba(255,255,255,.10)!important}.fj-install-web:hover{background:rgba(57,255,136,.06)!important;border-color:rgba(57,255,136,.20)!important}
      ...
      @media(max-width:900px){
        body{padding-left:0!important;padding-bottom:92px!important}
        ...
        .fj-mobile-nav{display:flex!important}
        .hero{min-height:auto!important;padding:96px 18px 45px!important;display:block!important}
        .hero h1{font-size:clamp(2.35rem,12vw,3.5rem)!important;letter-spacing:-1.8px!important}.hero p{font-size:.98rem!important}
        .hero-buttons{display:grid!important;grid-template-columns:1fr 1fr!important}.hero .button{padding:13px 10px!important;text-align:center!important}
        .hero-visual{min-height:355px!important;margin-top:25px!important;padding:48px 8px 45px!important}.money-card{width:calc(100% - 28px)!important;max-width:390px!important;padding:21px!important;border-radius:23px!important;transform:none!important;z-index:2!important}
        .hero-visual .float-card{font-size:.68rem!important;line-height:1.25!important;padding:8px 10px!important;border-radius:12px!important;animation:none!important;z-index:3!important;max-width:125px!important;white-space:normal!important}.hero-visual .float-card.one{top:2px!important;right:0!important;left:auto!important}.hero-visual .float-card.two{bottom:2px!important;left:0!important;right:auto!important}
        section{padding:48px 15px!important}.section-title{margin-bottom:24px!important}.section-title h2{font-size:1.75rem!important}
        .features,.tools,.interactive,.dashboard-grid,.dash-content{grid-template-columns:1fr!important;gap:12px!important}.feature,.panel,.interactive-card{padding:20px!important;border-radius:18px!important}.expense-form{grid-template-columns:1fr!important}
        .dashboard{padding:20px!important;border-radius:20px!important}.dashboard-card{padding:16px!important}.cta{padding:38px 18px!important;border-radius:20px!important}footer{padding-bottom:24px!important}
        #fjChatbot,#fjChatbotButton{bottom:92px!important}.fj-install-card{padding:29px 22px!important;border-radius:25px!important}
      }
  ...
  function setupNav(){
    ...
    items.forEach(([id,icon,label])=>{const b=document.createElement('button');b.type='button';b.dataset.target=id;b.innerHTML='<span>'+icon+'</span>'+label;b.addEventListener('click',()=>{if(id==='perfil'){if(typeof window.openAuth==='function')window.openAuth();else go('panel');return;}go(id);setActive(id);});nav.appendChild(b);});
