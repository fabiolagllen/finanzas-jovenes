...
function styles(){
 ...
 s.textContent=`#pagos.fj-reminders-section{scroll-margin-top:25px}.fj-reminders-app{margin-top:16px;padding:28px;border:1px solid #E6D7DD;border-radius:26px;background:linear-gradient(145deg,#0c1810,#07100a);box-shadow:0 18px 50px rgba(0,0,0,.25)}.fj-reminders-header{display:flex;gap:16px;align-items:center;padding-bottom:22px}.fj-reminders-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:17px;background:#102b1a;border:1px solid #CFAFBA;font-size:27px;box-shadow:0 0 24px rgba(57,255,136,.08)}.fj-reminders-header h3{margin:0;color:#292929;font-size:1.65rem}.fj-reminders-header p{margin:4px 0 0;color:#6F6870;font-size:.92rem}.fj-reminder-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px}.fj-reminder-stat{padding:16px;border-radius:16px;background:#0a150e;border:1px solid #E6D7DD}.fj-reminder-stat span{display:block;color:#82948a;font-size:.76rem}.fj-reminder-stat strong{display:block;color:#7A1F3D;font-size:1.5rem;margin-top:2px}.fj-reminder-main{display:grid;grid-template-columns:.9fr 1.1fr;gap:18px}.fj-reminder-card,.fj-reminder-list-wrap{padding:20px;border-radius:19px;background:#0a130d;border:1px solid #E6D7DD}.fj-reminder-card h4,.fj-reminder-list-wrap h4{margin:0 0 5px;color:#292929;font-size:1.05rem}.fj-reminder-help{color:#718278;font-size:.8rem;margin-bottom:15px}.fj-reminder-grid{display:grid;grid-template-columns:1fr 1fr;gap:11px}.fj-reminder-card label{display:grid;gap:6px;color:#554D53;font-size:.78rem;font-weight:700}.fj-reminder-card label.full{grid-column:1/-1}.fj-reminder-card label span{color:#718278;font-weight:400}.fj-reminder-card input,.fj-reminder-card select{box-sizing:border-box;width:100%;border:1px solid #E6D7DD;background:#07100a;color:#fff;border-radius:11px;padding:11px;font:inherit;outline:0}.fj-reminder-card input:focus,.fj-reminder-card select:focus{border-color:#7A1F3D;box-shadow:0 0 0 3px rgba(57,255,136,.08)}.fj-reminder-save{margin-top:13px;width:100%;border:0;border-radius:11px;padding:12px 17px;background:#7A1F3D;color:#FFFFFF;font-weight:800;cursor:pointer}.fj-reminder-save:disabled{opacity:.6;cursor:wait}.fj-reminder-message{margin-top:12px;padding:10px 12px;border-radius:10px;font-size:.83rem;display:none}.fj-reminder-message.show{display:block}.fj-reminder-message.error{background:#FFF0F0;color:#ffaaa8;border:1px solid #E4B2B2}.fj-reminder-message.success{background:#F6EAF0;color:#54152B;border:1px solid #CFAFBA}.fj-reminder-filter{display:flex;gap:7px;margin:12px 0 14px;flex-wrap:wrap}.fj-reminder-filter button{border:1px solid #E6D7DD;background:#07100a;color:#6F6870;border-radius:999px;padding:7px 11px;cursor:pointer;font-size:.75rem}.fj-reminder-filter button.active{background:#12351f;color:#7A1F3D;border-color:#7A1F3D}.fj-reminder-list{display:grid;gap:9px;max-height:520px;overflow:auto;padding-right:2px}.fj-reminder-item{display:grid;grid-template-columns:auto 1fr auto;gap:11px;align-items:center;padding:14px;border:1px solid #E6D7DD;border-radius:15px;background:#0b1610}.fj-reminder-item.is-paid{opacity:.52}.fj-reminder-item.is-paid .fj-reminder-title{text-decoration:line-through}.fj-reminder-check{width:35px;height:35px;border:1px solid #D8BEC8;background:#F6EAF0;color:#7A1F3D;border-radius:50%;font-size:1rem;cursor:pointer}.fj-reminder-info{min-width:0}.fj-reminder-title{display:block;color:#292929;font-weight:800;overflow-wrap:anywhere}.fj-reminder-date{display:block;color:#6F6870;font-size:.76rem;margin-top:3px}.fj-reminder-badges{display:flex;gap:5px;flex-wrap:wrap;margin-top:6px}.fj-reminder-badge{display:inline-block;padding:3px 7px;border-radius:999px;background:#10281a;color:#54152B;border:1px solid #CFAFBA;font-size:.68rem}.fj-reminder-badge.warning{background:#2a2010;color:#ffe27a;border-color:#66552b}.fj-reminder-badge.danger{background:#FFF0F0;color:#ffaaa8;border-color:#E4B2B2}.fj-reminder-actions{display:flex;gap:5px}.fj-reminder-actions button{border:1px solid #E6D7DD;background:transparent;color:#c5d1ca;border-radius:8px;padding:7px 8px;cursor:pointer;font-size:.72rem}.fj-reminder-actions .delete:hover{color:#ff6978;border-color:#E4B2B2}.fj-reminder-empty{padding:30px 15px;text-align:center;border:1px dashed #E6D7DD;border-radius:14px;color:#7f9187}.fj-reminder-empty b{display:block;color:#554D53;margin-bottom:4px;font-size:.95rem}.fj-reminder-empty span{font-size:.8rem}.fj-editing{border-color:#7A1F3D!important;box-shadow:0 0 0 2px rgba(57,255,136,.06)}@media(max-width:900px){.fj-reminders-app{padding:18px 12px}.fj-reminder-stats{grid-template-columns:1fr 1fr}.fj-reminder-stat:last-child{grid-column:1/-1}.fj-reminder-main{grid-template-columns:1fr}.fj-reminder-grid{grid-template-columns:1fr}.fj-reminder-card label.full{grid-column:auto}.fj-reminder-actions{flex-direction:column}.fj-reminder-actions button{padding:6px}.fj-reminders-header h3{font-size:1.35rem}}`;
