...
function styles(){
 ...
 s.textContent=`#pagos.fj-reminders-section{scroll-margin-top:25px}.fj-reminders-app{margin-top:16px;padding:28px;border:1px solid #294034;border-radius:26px;background:linear-gradient(145deg,#0c1810,#07100a);box-shadow:0 18px 50px rgba(0,0,0,.25)}.fj-reminders-header{display:flex;gap:16px;align-items:center;padding-bottom:22px}.fj-reminders-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:17px;background:#102b1a;border:1px solid #316343;font-size:27px;box-shadow:0 0 24px rgba(57,255,136,.08)}.fj-reminders-header h3{margin:0;color:#f4faf6;font-size:1.65rem}.fj-reminders-header p{margin:4px 0 0;color:#9eafa5;font-size:.92rem}.fj-reminder-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px}.fj-reminder-stat{padding:16px;border-radius:16px;background:#0a150e;border:1px solid #294034}.fj-reminder-stat span{display:block;color:#82948a;font-size:.76rem}.fj-reminder-stat strong{display:block;color:#39ff88;font-size:1.5rem;margin-top:2px}.fj-reminder-main{display:grid;grid-template-columns:.9fr 1.1fr;gap:18px}.fj-reminder-card,.fj-reminder-list-wrap{padding:20px;border-radius:19px;background:#0a130d;border:1px solid #294034}.fj-reminder-card h4,.fj-reminder-list-wrap h4{margin:0 0 5px;color:#f4faf6;font-size:1.05rem}.fj-reminder-help{color:#718278;font-size:.8rem;margin-bottom:15px}.fj-reminder-grid{display:grid;grid-template-columns:1fr 1fr;gap:11px}.fj-reminder-card label{display:grid;gap:6px;color:#dce9e1;font-size:.78rem;font-weight:700}.fj-reminder-card label.full{grid-column:1/-1}.fj-reminder-card label span{color:#718278;font-weight:400}.fj-reminder-card input,.fj-reminder-card select{box-sizing:border-box;width:100%;border:1px solid #294034;background:#07100a;color:#fff;border-radius:11px;padding:11px;font:inherit;outline:0}.fj-reminder-card input:focus,.fj-reminder-card select:focus{border-color:#39ff88;box-shadow:0 0 0 3px rgba(57,255,136,.08)}.fj-reminder-save{margin-top:13px;width:100%;border:0;border-radius:11px;padding:12px 17px;background:#39ff88;color:#041008;font-weight:800;cursor:pointer}.fj-reminder-save:disabled{opacity:.6;cursor:wait}.fj-reminder-message{margin-top:12px;padding:10px 12px;border-radius:10px;font-size:.83rem;display:none}.fj-reminder-message.show{display:block}.fj-reminder-message.error{background:#2a1212;color:#ffaaa8;border:1px solid #5c2929}.fj-reminder-message.success{background:#0c2416;color:#8fffb5;border:1px solid #28553a}.fj-reminder-filter{display:flex;gap:7px;margin:12px 0 14px;flex-wrap:wrap}.fj-reminder-filter button{border:1px solid #294034;background:#07100a;color:#9eafa5;border-radius:999px;padding:7px 11px;cursor:pointer;font-size:.75rem}.fj-reminder-filter button.active{background:#12351f;color:#39ff88;border-color:#39ff88}.fj-reminder-list{display:grid;gap:9px;max-height:520px;overflow:auto;padding-right:2px}.fj-reminder-item{display:grid;grid-template-columns:auto 1fr auto;gap:11px;align-items:center;padding:14px;border:1px solid #294034;border-radius:15px;background:#0b1610}.fj-reminder-item.is-paid{opacity:.52}.fj-reminder-item.is-paid .fj-reminder-title{text-decoration:line-through}.fj-reminder-check{width:35px;height:35px;border:1px solid #31503d;background:#0d2116;color:#39ff88;border-radius:50%;font-size:1rem;cursor:pointer}.fj-reminder-info{min-width:0}.fj-reminder-title{display:block;color:#f4faf6;font-weight:800;overflow-wrap:anywhere}.fj-reminder-date{display:block;color:#9eafa5;font-size:.76rem;margin-top:3px}.fj-reminder-badges{display:flex;gap:5px;flex-wrap:wrap;margin-top:6px}.fj-reminder-badge{display:inline-block;padding:3px 7px;border-radius:999px;background:#10281a;color:#8fffb5;border:1px solid #28553a;font-size:.68rem}.fj-reminder-badge.warning{background:#2a2010;color:#ffe27a;border-color:#66552b}.fj-reminder-badge.danger{background:#2a1212;color:#ffaaa8;border-color:#5c2929}.fj-reminder-actions{display:flex;gap:5px}.fj-reminder-actions button{border:1px solid #294034;background:transparent;color:#c5d1ca;border-radius:8px;padding:7px 8px;cursor:pointer;font-size:.72rem}.fj-reminder-actions .delete:hover{color:#ff6978;border-color:#5c2929}.fj-reminder-empty{padding:30px 15px;text-align:center;border:1px dashed #294034;border-radius:14px;color:#7f9187}.fj-reminder-empty b{display:block;color:#dce9e1;margin-bottom:4px;font-size:.95rem}.fj-reminder-empty span{font-size:.8rem}.fj-editing{border-color:#39ff88!important;box-shadow:0 0 0 2px rgba(57,255,136,.06)}@media(max-width:900px){.fj-reminders-app{padding:18px 12px}.fj-reminder-stats{grid-template-columns:1fr 1fr}.fj-reminder-stat:last-child{grid-column:1/-1}.fj-reminder-main{grid-template-columns:1fr}.fj-reminder-grid{grid-template-columns:1fr}.fj-reminder-card label.full{grid-column:auto}.fj-reminder-actions{flex-direction:column}.fj-reminder-actions button{padding:6px}.fj-reminders-header h3{font-size:1.35rem}}`;
...
function mount(){
 ...
 mount.innerHTML=`<div class="fj-reminders-app"><div class="fj-reminders-header"><div class="fj-reminders-icon">🔔</div><div><h3>Centro de recordatorios</h3><p>Organiza tus pagos y fechas importantes para que nada se te pase.</p></div></div><div class="fj-reminder-stats"><div class="fj-reminder-stat"><span>📌 Pendientes</span><strong id="fjStatPending">0</strong></div><div class="fj-reminder-stat"><span>⏰ Próximos</span><strong id="fjStatNext">0</strong></div><div class="fj-reminder-stat"><span>✅ Completados</span><strong id="fjStatDone">0</strong></div></div><div class="fj-reminder-main"><div class="fj-reminder-card" id="fjReminderEditor"><h4 id="fjReminderFormTitle">➕ Nuevo recordatorio</h4><p class="fj-reminder-help">Crea un aviso para un pago, tarea o fecha importante.</p><form id="fjReminderForm"><div class="fj-reminder-grid"><label class="full">¿Qué quieres recordar?<input id="fjReminderTitle" maxlength="100" placeholder="Ej. Pagar internet" required></label><label>Monto <span>opcional</span><input id="fjReminderAmount" type="number" min="0" step="0.01" placeholder="Q 0.00"></label><label>Fecha<input id="fjReminderDate" type="date" required></label><label>Hora <span>opcional</span><input id="fjReminderTime" type="time"></label><label>Recordarme <span>antes</span><select id="fjReminderDays"><option value="0">El mismo día</option><option value="1" selected>1 día antes</option><option value="2">2 días antes</option><option value="3">3 días antes</option><option value="7">1 semana antes</option><option value="14">2 semanas antes</option></select></label></div><button class="fj-reminder-save" id="fjReminderSave" type="submit">🔔 Guardar recordatorio</button><button type="button" id="fjReminderCancel" style="display:none;width:100%;margin-top:7px;border:1px solid #294034;background:transparent;color:#9eafa5;border-radius:11px;padding:10px;cursor:pointer">Cancelar edición</button><div id="fjReminderMessage" class="fj-reminder-message"></div></form></div><div class="fj-reminder-list-wrap"><h4>📅 Mis recordatorios</h4><div class="fj-reminder-filter"><button type="button" class="active" data-filter="pending">Pendientes</button><button type="button" data-filter="all">Todos</button><button type="button" data-filter="done">Completados</button></div><div id="fjReminderList" class="fj-reminder-list"></div></div></div></div>`;
 const form=$('#fjReminderForm');if(form)form.addEventListener('submit',save);
...
async function save(e){
 ...
 const title=$('#fjReminderTitle').value.trim(),date=$('#fjReminderDate').value,time=$('#fjReminderTime').value,amount=Number($('#fjReminderAmount').value||0),days=Number($('#fjReminderDays').value||0),button=$('#fjReminderSave');
 if(!title||!date)return;
 button.disabled=true;button.textContent='Guardando...';
 const payload={title,amount:amount>0?amount:0,due_date:date,remind_days_before:Math.max(0,Math.min(days,30)),remind_time:time||null};
 let result;
...
async function load(){
 ...
 const c=client();if(!c)return;
 const {data,error}=await c.from('payment_reminders').select('id,title,amount,due_date,remind_days_before,remind_time,paid').eq('user_id',s.user.id).order('paid',{ascending:true}).order('due_date',{ascending:true});
